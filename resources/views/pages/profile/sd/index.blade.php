...
@section('foreground')
    <h1 class="text-4xl font-bold text-white mb-4">Bidang SD</h1>
    <nav class="text-sm text-gray-200">
        <ol class="flex justify-center space-x-2">
            <li><a href="/" class="text-white hover:underline">Home</a></li>
            <li>/</li>
            <li class="text-white">Bidang SD</li>
        </ol>
    </nav>
@endsection
...
@section('navtab')
    <button class="tab-btn w-full flex items-center text-left border p-4 rounded bg-blue-50" data-tab="1">
        ...
        <span class="font-medium">Bidang SD</span>
    </button>
...
@section('content1')
    <div class="bg-white shadow-xl p-9 w-full">
        <h2 style="font-size: 22px; font-weight: bold;">Bidang SD</h2>
