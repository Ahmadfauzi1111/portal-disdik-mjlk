...
<nav class="fixed top-0 z-50 w-full flex flex-col bg-blue-700 transition-colors ease-brand duration-250 lg:bg-black/30 lg:backdrop-filter lg:backdrop-blur-lg lg:hover:bg-blue-700">
    <div class="container mx-auto flex items-center justify-between lg:justify-center px-4 sm:px-6 lg:px-8 h-20">
        <!-- Logo -->
        <a href="/" aria-label="Beranda" class="w-7 h-9 lg:w-[38px] lg:h-[38px] xl:w-[197px] xl:h-[38px]">
        ...
        <ul class="hidden lg:flex items-center gap-4 text-white ml-6 relative">
            ...
            <li class="relative">
                <a href="{{ route('hallo-disdik') }}" class="flex items-center gap-2 cursor-pointer px-2 py-1 rounded-lg hover:bg-blue-600 hover:bg-opacity-40">
                    <span class="leading-7">Hallo Disdik</span>
                </a>
            </li>

            <li class="relative">
                <a href="{{ route('public_service') }}" class="flex items-center gap-2 cursor-pointer px-2 py-1 rounded-lg hover:bg-blue-600 hover:bg-opacity-40">
                    <span class="leading-7">Layanan Publik</span>
                </a>
            </li>

            <li class="relative">
                <a href="{{ route('publikasi') }}" class="flex items-center gap-2 cursor-pointer px-2 py-1 rounded-lg hover:bg-blue-600 hover:bg-opacity-40">
            ...
            <li class="relative">
                ...
                <ul
                    id="submenu-ppid"
                    class="absolute top-full left-0 mt-1 bg-blue-700 rounded-md shadow-lg hidden min-w-[400px] z-10"
                    role="menu"
                    aria-labelledby="btn-ppid"
                >
                    <li><a href="{{ route('ppid') }}" class="block px-4 py-2 hover:bg-blue-600" role="menuitem">Profile PPID</a></li>
                    <li><a href="{{ route('public_information_list') }}" class="block px-4 py-2 hover:bg-blue-600" role="menuitem">Daftar Informasi Publik</a></li>
                    <li><a href="https://www.lapor.go.id/" class="block px-4 py-2 hover:bg-blue-600" role="menuitem">Layanan Aspirasi dan Pengaduan Online Rakyat</a></li>
                    <li><a href="https://simonevyanlik.majalengkakab.go.id/" class="block px-4 py-2 hover:bg-blue-600" role="menuitem">Survey Kepuasan Masyarakat</a></li>
                </ul>
            </li>
        </ul>
